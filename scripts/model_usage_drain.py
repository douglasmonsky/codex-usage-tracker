...
def main() -> int:
    ...
    if args.json:
        ...
        if boundary:
            ...
            best_boundary_delta_rmse = _best_metric_model(
                boundary_delta_scope.get("models") or {},
                "rmse",
            )
            gate_diagnostics = (
        ...
        if breakpoints.get("span_count"):
            ...
            print(
                ...
                "piecewise_r2={piecewise_r2} piecewise_mae={piecewise_mae} "
                "ceiling_r2={ceiling_r2} ceiling_mae={ceiling_mae} "
                ...
                "split_right={right}".format(
                    ...
                    piecewise_r2=piecewise_fit.get("r2"),
                    piecewise_mae=piecewise_fit.get("mae"),
                    ceiling_r2=ceiling_fit.get("r2"),
                    ceiling_mae=ceiling_fit.get("mae"),
