...
REQUIRED_FILES = [
    ...
    "docs/assets/dashboard-sessions.png",
    ...
    "src/codex_usage_tracker/plugin_data/dashboard/dashboard_actions.js",
    "src/codex_usage_tracker/plugin_data/dashboard/dashboard_live.js",
    ...
    *DASHBOARD_LOCALE_SOURCE_FILES,
    ...
    "src/codex_usage_tracker/plugin_data/docs/assets/dashboard-sessions.png",
...
WHEEL_REQUIRED_MEMBERS = {
    ...
    "codex_usage_tracker/plugin_data/dashboard/dashboard_actions.js",
    "codex_usage_tracker/plugin_data/dashboard/dashboard_live.js",
    ...
    *DASHBOARD_LOCALE_WHEEL_MEMBERS,
    ...
    "codex_usage_tracker/plugin_data/docs/assets/dashboard-sessions.png",
