...
through 0.25.x. The notice pages provide replacement core requests and direct
paths to Evidence, Explore, and Limits. These compatibility surfaces are due
for removal in 0.26.0 after the post-release amendment made 0.25.0 the
central-product reliability release; there is no early removal in this release.
