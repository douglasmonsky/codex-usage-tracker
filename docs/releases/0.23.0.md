...
No manual database step is required. Startup applies schema migration 32, which
adds a newest-first index for bounded all-history allowance evidence without
rewriting stored usage rows.
...
The candidate passes 1,880 Python tests at 88% coverage, 607 frontend tests,
and 14 Playwright release-candidate scenarios. Initial dashboard payloads are
