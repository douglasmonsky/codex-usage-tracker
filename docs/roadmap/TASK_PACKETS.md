...
- [x] **CK-QG1 — Enforce replacement-kernel maintainability** · PR #392 hosted-green, squash-merged at `68050b93`, and exact-main verified with the exact authorized successor baseline · [packet](tasks/ck-qg1-enforce-agent-kernel-maintainability.md)
