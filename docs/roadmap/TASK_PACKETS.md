...
- [ ] **CK-07R1 — Correct lifecycle preparation scale** · Conditional Ready after exact successor authority for the `66c015de…` / `f173837d…` / `b6468b60…` cohort merges and exact-main verifies; only the existing worker may resume and no launch is yet authorized; PR #394 is stale read-only · [packet](tasks/ck-07r1-correct-lifecycle-preparation-scale.md)
