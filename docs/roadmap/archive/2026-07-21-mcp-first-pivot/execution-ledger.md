# Archived: MCP-First Pivot Execution Ledger

> Historical record archived on 2026-07-26. Entries remain immutable release
> evidence but no longer authorize future tasks. New work is recorded in the
> [Product Kernel Reset execution ledger](../../product-kernel-reset-execution.md).

This ledger is the durable historical handoff for the
[archived MCP-first pivot](roadmap.md). Its entries were updated in the same
commit as each completed roadmap task.
