# Archived: MCP-First Product Pivot

> Historical record archived on 2026-07-26. This roadmap no longer authorizes
> implementation work. The active program is the
> [Product Kernel Reset](../../product-kernel-reset.md).

This document was the normative release sequence for the MCP-first product
pivot. The archived
[design](../../../superpowers/specs/archive/2026-07-21-mcp-first-product-pivot-design.md)
and
[implementation roadmap](../../../superpowers/plans/archive/2026-07-21-mcp-first-product-pivot.md)
remain the detailed historical contracts for the program.
...
Compatibility was bounded by [the archived deprecation ledger](deprecations.md).
An
...
[execution ledger](execution-ledger.md). Release, compatibility, schema,
