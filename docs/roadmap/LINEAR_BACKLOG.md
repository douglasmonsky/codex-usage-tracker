...
| CK-12 | Pass the full correctness and performance qualification | P4 | M3 | CK-11 | workstream:qualification, type:performance, cutover:blocker | L0–L5, all scales/ranges, crash/lock, package, call/byte/token/latency gates pass with <=3% ratchets. |
