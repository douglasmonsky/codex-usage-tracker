...
```bash
python scripts/smoke_installed_package.py --from-pypi --version 0.12.0
python scripts/smoke_installed_package.py --docker --from-pypi --version 0.12.0
```
...
git switch main
git pull --ff-only
git tag -a v0.12.0 -m "codex-usage-tracker 0.12.0"
