...
USAGE_EVENT_COLUMNS = (
    ...
    UsageColumn("source_byte_start", "INTEGER", "INTEGER", repairable=True),
    UsageColumn("source_byte_end", "INTEGER", "INTEGER", repairable=True),
    UsageColumn("turn_start_line", "INTEGER", "INTEGER", repairable=True),
    UsageColumn("turn_start_byte", "INTEGER", "INTEGER", repairable=True),
