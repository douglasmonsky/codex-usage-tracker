"""Goal-led investigation MCP implementation tools."""
...
from codex_usage_tracker.interfaces.mcp.mcp_compression_router import (
    build_compression_action_router,
    build_compression_investigation_router,
    is_compression_router_goal,
)
from codex_usage_tracker.interfaces.mcp.mcp_dashboard import attach_dashboard_targets
from codex_usage_tracker.interfaces.mcp.mcp_discovery import _pattern_scan_payload
