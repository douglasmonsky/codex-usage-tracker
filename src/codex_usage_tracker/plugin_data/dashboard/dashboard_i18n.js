(function () {
  const builtInFallbackTranslations = {
    ...
    'dashboard.view.sessions': 'Sessions',
    ...
    'state.no_sessions': 'No work sessions match the current filters.',
    ...
    'table.ended': 'Ended',
    'table.idle_before': 'Idle before',
    'table.duration': 'Duration',
    'table.largest_miss': 'Largest miss',
    'table.context_peak': 'Context peak',
    'table.action': 'Action',
    ...
    'session.caption': 'Showing work sessions split by cold-resume boundaries, sorted by {sort}. {loaded}.',
    'session.loading': 'Loading work sessions...',
    'session.error': 'Could not load work sessions: {message}',
    'session.filter.all': 'All sessions',
    'session.filter.cold': 'Cold resumes',
    'session.filter.high_uncached': 'High uncached',
    'session.filter.needs_handoff': 'Needs handoff',
    'session.filter.recent': 'Recent',
    'session.action.monitor': 'Monitor',
    'session.action.inspect_cold_resume': 'Inspect cold resume',
    'session.action.handoff_or_start_fresh': 'Start fresh / hand off',
    'session.context_segments': 'Context segments',
    'session.context_segments_hint': 'Aggregate-only segments split at detected compaction boundaries.',
    'session.epoch.effectiveness': 'Effectiveness',
    'session.epoch.error': 'Could not load context segments: {message}',
    'session.epoch.first_miss': 'First miss',
    'session.epoch.loading': 'Loading context segments...',
    'session.epoch.none': 'No context segments found for this session.',
    'session.epoch.segment': 'Segment',
    'session.effectiveness.effective': 'Effective',
    'session.effectiveness.ineffective': 'Ineffective',
    'session.effectiveness.mixed': 'Mixed',
    'session.effectiveness.unknown': 'Unknown',
    'session.reason.session_start': 'Session start',
    'session.reason.thread_start': 'Thread start',
    'session.reason.cold_resume': 'Cold resume',
    'session.reason.post_compaction': 'Post-compaction',
    'session.minutes': '{minutes}m',
    'session.hours_minutes': '{hours}h {minutes}m',
    'metric.usage_observed': 'Usage observed',
    'allowance.observed_age_days': '{count}d ago',
    'allowance.observed_age_hours': '{count}h ago',
    'allowance.observed_age_minutes': '{count}m ago',
    'allowance.observed_age_now': 'just now',
    'allowance.observed_last': 'Last observed {age}.',
    'allowance.observed_limit': 'Limit: {limit}.',
    'allowance.observed_plan': 'Plan: {plan}.',
    ...
    'allowance.live_check_recommended': 'The latest {count} Codex calls reported alternate limit bucket {limit}, so this local snapshot may be stale. A live usage check is recommended before trusting the top-card remaining usage.',
    'allowance.alternate_limit_hint': 'This call reported limit_id {limit}. The local snapshot showed no observed 5h/weekly usage movement for that bucket, so allowance impact is not estimated.',
