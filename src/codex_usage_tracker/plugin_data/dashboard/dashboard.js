    ...
    const builtInFallbackTranslations = {
      ...
      'call.serialized_breakdown': 'Serialized evidence buckets',
      ...
      'context.thread_anchors': 'Call anchors',
      'context.thread_anchors_hint': 'Nearest visible message before this call and reasoning output for the selected call when available.',
      'context.anchor_before': 'Before this call',
      'context.anchor_reasoning_output': 'Reasoning output',
      'context.anchor_count': '{count} anchors loaded.',
