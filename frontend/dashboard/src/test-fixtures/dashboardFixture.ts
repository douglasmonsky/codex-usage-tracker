...
export const fixtureModel: DashboardModel = {
  ...
  calls: [
    ...
    return {
      ...
      standardCost: index === 4 ? 0 : Number(cost),
      priorityCost: index === 4 ? 0 : Number(cost) * 2,
      ...
      fast: null,
      serviceTierSource: '',
      serviceTierConfidence: '',
      fastProxyCandidate: Boolean(fast),
      standardUsageCredits: (index === 4 ? 0 : Number(cost)) * 25,
      fastUsageCredits: (index === 4 ? 0 : Number(cost)) * 50,
      usageCreditMultiplier: 1,
      usageCreditMultiplierSource: 'tier_unknown',
      usageCreditMultiplierSourceUrl: 'https://example.invalid/fixture-fast',
