...
const fallbackTranslations: Record<string, string> = {
  ...
  'settings.experimental.title': 'Compatibility and Labs',
  'settings.experimental.subtitle': 'Advanced browser-local preference',
  'settings.experimental.toggle': 'Show compatibility and Labs links',
  'settings.experimental.origin_scope': 'This browser-local preference reveals temporary direct links. Labs never join primary navigation.',
  'settings.experimental.labs_title': 'Compatibility Labs',
  'settings.experimental.labs_subtitle': 'Direct-only routes during the migration window',
